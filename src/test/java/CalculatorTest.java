...
public class CalculatorTest {
	...
	public void testAddSmallSizedPositiveNumbers() {
		...
		for(int i = 0;i<200;i++) {
			...
			LOG.info("Testing the add method with small sized positive numbers: "+ firstNumber +" and " + secondNumber);
		...
		public void testAddMediumSizedPositiveNumbers() {
			...
			for(int i = 0;i<200;i++) {
				...
				LOG.info("Testing the add method with medium sized positive numbers: "+ firstNumber +" and " + secondNumber);
				assertEquals(Math.round(calculator.add(firstNumber, secondNumber)), Math.round(result),1);
			}
		}
		@Test
		public void testAddLargesizedPositiveNumbers() {
			...
			for(int i = 0;i<200;i++) {
				...
				LOG.info("Testing the add method with large sized positive numbers: "+ firstNumber +" and " + secondNumber);
				assertEquals(Math.round(calculator.add(firstNumber, secondNumber)), Math.round(result),1);
